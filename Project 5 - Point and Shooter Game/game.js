...
const collisionCanvas = document.getElementById('collisionCanvas-el')
...
class Particle {
    constructor(x, y, size, color){
        ...
        this.y = y + this.size / 3.2 + Math.random() * 50 - 25
...
function animate(timeStamp){
    ...
    // perioding events (for power of computer)
    ...
    if(timeToNextRaven > ravenInterval){
        ...
        //bigger at front, smaller at back
        ravens.sort((a, b) => {
